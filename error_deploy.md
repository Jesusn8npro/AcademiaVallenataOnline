Commit: fix: usar npx en el build para resolver error de comando no encontrado en Easypanel 
##########################################
### Download Github Archive Started...
### Tue, 21 Apr 2026 22:31:40 GMT
##########################################
...
#15 339.2 
#15 339.2 up to date, audited 354 packages in 6m
#15 339.2 
#15 339.2 56 packages are looking for funding
#15 339.2   run `npm fund` for details
#15 339.2 
#15 339.2 1 high severity vulnerability
#15 339.2 
#15 339.2 To address all issues, run:
#15 339.2   npm audit fix
#15 339.2 
#15 339.2 Run `npm audit` for details.
#15 DONE 339.3s
...
#17 0.231 
#17 0.231 > mi-app@0.0.0 build
#17 0.231 > node scripts/sync-samples.cjs && npx vite build
#17 0.231 
#17 0.275 ✅ Sincronización completa. 34 pitos y 20 bajos detectados.
#17 0.275 📂 Lista guardada en: /app/public/muestrasLocales.json
#17 1.244 npm warn exec The following package was not found and will be installed: vite@6.4.2
#17 78.85 failed to load config from /app/vite.config.ts
#17 78.85 error during build:
#17 78.85 Error [ERR_MODULE_NOT_FOUND]: Cannot find package 'vite' imported from /app/node_modules/.vite-temp/vite.config.ts.timestamp-1776811129238-6158d78530cc5.mjs
#17 78.85     at packageResolve (node:internal/modules/esm/resolve:838:9)
#17 78.85     at moduleResolve (node:internal/modules/esm/resolve:907:18)
#17 78.85     at defaultResolve (node:internal/modules/esm/resolve:1037:11)
#17 78.85     at ModuleLoader.defaultResolve (node:internal/modules/esm/loader:650:12)
#17 78.85     at #cachedDefaultResolve (node:internal/modules/esm/loader:599:25)
#17 78.85     at ModuleLoader.resolve (node:internal/modules/esm/loader:582:38)
#17 78.85     at ModuleLoader.getModuleJobForImport (node:internal/modules/esm/loader:241:38)
#17 78.85     at ModuleJob._link (node:internal/modules/esm/module_job:132:49)
...
78.85 error during build:
78.85 Error [ERR_MODULE_NOT_FOUND]: Cannot find package 'vite' imported from /app/node_modules/.vite-temp/vite.config.ts.timestamp-1776811129238-6158d78530cc5.mjs
78.85     at packageResolve (node:internal/modules/esm/resolve:838:9)
78.85     at moduleResolve (node:internal/modules/esm/resolve:907:18)
78.85     at defaultResolve (node:internal/modules/esm/resolve:1037:11)
78.85     at ModuleLoader.defaultResolve (node:internal/modules/esm/loader:650:12)
78.85     at #cachedDefaultResolve (node:internal/modules/esm/loader:599:25)
78.85     at ModuleLoader.resolve (node:internal/modules/esm/loader:582:38)
78.85     at ModuleLoader.getModuleJobForImport (node:internal/modules/esm/loader:241:38)
78.85     at ModuleJob._link (node:internal/modules/esm/module_job:132:49)
------
