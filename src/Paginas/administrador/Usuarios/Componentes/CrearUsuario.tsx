...
import { useCrearUsuario, type Usuario } from './useCrearUsuario';
...
const CrearUsuario: React.FC<Props> = ({ onCerrar, onUsuarioCreado }) => {
  const { cargando, error, exito, datos, limpiarFormulario, crearUsuarioLocal, manejarEntradaTexto, manejarCambioDatos } = useCrearUsuario(onUsuarioCreado);
      ...
      {!exito && (
        <form onSubmit={(e) => { e.preventDefault(); crearUsuarioLocal(); }} className="crear-usuario-formulario">
            ...
            <div className="crear-usuario-campos-grupo">
              <div className="crear-usuario-campo crear-usuario-campo-obligatorio">
                ...
                <input
                  ...
                  required placeholder="Nombre del usuario" maxLength={100}
                />
              </div>
              ...
              <div className="crear-usuario-campo crear-usuario-campo-obligatorio">
                ...
                <input
                  ...
                  onInput={manejarEntradaTexto}
                  required placeholder="Apellido del usuario" maxLength={100}
                />
              </div>
              ...
              <div className="crear-usuario-campo">
                ...
                <input
                  id="nombre_usuario" name="nombre_usuario" type="text"
                  value={datos.nombre_usuario}
                  onChange={(e) => manejarCambioDatos('nombre_usuario', e.target.value)}
                  onInput={manejarEntradaTexto}
                  placeholder="Se generará automáticamente si no se especifica" maxLength={50}
                />
              </div>
              ...
              <div className="crear-usuario-campo crear-usuario-campo-obligatorio">
                ...
                <input
                  ...
                  required placeholder="correo@ejemplo.com" maxLength={255}
                />
              </div>
              ...
              <div className="crear-usuario-campo crear-usuario-campo-obligatorio">
                ...
                <input
                  ...
                  required placeholder="Mínimo 6 caracteres" minLength={6} maxLength={100}
                />
              </div>
            </div>
          </div>
          ...
          <div className="crear-usuario-seccion">
            ...
            <div className="crear-usuario-campos-grupo">
              <div className="crear-usuario-campo">
                ...
                <select id="rol" value={datos.rol} onChange={(e) => manejarCambioDatos('rol', e.target.value)}>
              ...
              <div className="crear-usuario-campo">
                ...
                <select id="suscripcion" value={datos.suscripcion} onChange={(e) => manejarCambioDatos('suscripcion', e.target.value)}>
            ...
            <div className="crear-usuario-campos-grupo">
              <div className="crear-usuario-campo">
                ...
                <input
                  ...
                  onInput={manejarEntradaTexto}
                  placeholder="Ciudad de residencia" maxLength={100}
                />
              </div>
              ...
              <div className="crear-usuario-campo">
                ...
                <input
                  ...
                  onInput={manejarEntradaTexto}
                  placeholder="País de residencia" maxLength={100}
                />
              </div>
              ...
              <div className="crear-usuario-campo">
                ...
                <select id="nivel" value={datos.nivel_habilidad} onChange={(e) => manejarCambioDatos('nivel_habilidad', e.target.value)}>
              ...
              <div className="crear-usuario-campo">
                ...
                <select id="documento_tipo" value={datos.documento_tipo} onChange={(e) => manejarCambioDatos('documento_tipo', e.target.value)}>
              ...
              <div className="crear-usuario-campo">
                ...
                <input
                  ...
                  placeholder="Número del documento" maxLength={20}
                />
              </div>
              ...
              <div className="crear-usuario-campo">
                ...
                <input
                  id="profesion" name="profesion" type="text"
                  value={datos.profesion}
                  onChange={(e) => manejarCambioDatos('profesion', e.target.value)}
                  onInput={manejarEntradaTexto}
                  placeholder="Profesión u ocupación" maxLength={100}
                />
              </div>

              <div className="crear-usuario-campo">
                <label htmlFor="instrumento">Instrumento Principal</label>
                <select id="instrumento" value={datos.instrumento} onChange={(e) => manejarCambioDatos('instrumento', e.target.value)}>
          ...
          <div className="crear-usuario-acciones-formulario">
            <button type="button" className="crear-usuario-btn-limpiar" onClick={limpiarFormulario} disabled={cargando}>
              Limpiar
            </button>
            <button type="submit" className="crear-usuario-btn-crear" disabled={cargando}>
