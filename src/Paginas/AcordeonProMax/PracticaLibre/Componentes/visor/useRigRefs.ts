...
export interface RigRefs {
  ...
  brazoIzq: React.MutableRefObject<{ bones: THREE.Object3D[]; qAgarre: THREE.Quaternion[]; qClosed: THREE.Quaternion[] }>
  // Caja de bajos: mantiene la mano sobre los botones siguiendo el morph.
  cajaGrip: React.MutableRefObject<{ caja: THREE.Mesh; handLocalBind: THREE.Vector3; dCerrar: THREE.Vector3; dAbrir: THREE.Vector3; restW: number } | null>
  ...
  botones: React.MutableRefObject<Record<string, { mesh: THREE.Mesh; orig: THREE.Vector3; sink: THREE.Vector3; mat: any; emisivoBase: THREE.Color; localCenter: THREE.Vector3 }>>
...
export function useRigRefs(): RigRefs {
  return {
    ...
    brazoIzq: React.useRef<{ bones: THREE.Object3D[]; qAgarre: THREE.Quaternion[]; qClosed: THREE.Quaternion[] }>({ bones: [], qAgarre: [], qClosed: [] }),
    cajaGrip: React.useRef<{ caja: THREE.Mesh; handLocalBind: THREE.Vector3; dCerrar: THREE.Vector3; dAbrir: THREE.Vector3; restW: number } | null>(null),
    ...
    botones: React.useRef<Record<string, { mesh: THREE.Mesh; orig: THREE.Vector3; sink: THREE.Vector3; mat: any; emisivoBase: THREE.Color; localCenter: THREE.Vector3 }>>({}),
