...
export const primeraFila: BotonNota[] = [
    // Halar (Pull)
...
export const segundaFila: BotonNota[] = [
    // Halar (Pull)
...
export const terceraFila: BotonNota[] = [
    // Halar (Pull)
...
export const disposicionBajos: Record<string, BotonNota[]> = {
    una: [
...
export const escalas: Record<string, { notes: string[][], thirds: string[][] }> = {
    F: {
        notes: [
            ['3-3-halar'],
            ['1-6-halar'],
        ...
        thirds: [
            ...
            ['1-9-halar', '2-7-halar'],
            ['3-7-halar', '3-6-halar'],
            ['1-9-halar', '1-10-halar'],
            ['2-10-halar', '3-7-halar'],
        ],
    },
    Bb: {
        notes: [
