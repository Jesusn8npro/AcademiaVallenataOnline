...
const extraerYouTubeId = (valor: string) => {
...
const ModalGuardarHero: React.FC<ModalGuardarHeroProps> = ({
    visible,
    onCerrar,
    onGuardar,
    bpm,
        ...
        <div style={overlayStyle} onClick={onCerrar}>
            <div style={modalStyle} onClick={e => e.stopPropagation()}>
                ...
                <div style={bodyStyle}>
                    ...
                    <div style={fieldGroup}>
                        ...
                        <textarea
                            ...
                            style={textareaStyle}
                            placeholder="Referencia, observaciones o descripcion del ejercicio"
                        />
                    </div>
                    ...
                    <div style={fieldGroup}>
                        ...
                        <div style={optionGrid}>
                            ...
                            <button onClick={() => setTipo('cancion')} style={optionBtn(tipo === 'cancion')}>
                                <Music size={16} /> CANCION
                            </button>
                        </div>
                    </div>
                ...
                <div style={footerStyle}>
                    ...
                    <button style={saveBtn} onClick={guardar}>
...
const modalStyle: React.CSSProperties = {
    background: '#121212', width: '420px', maxWidth: 'calc(100vw - 32px)', maxHeight: 'calc(100vh - 32px)', borderRadius: '24px',
...
const footerStyle: React.CSSProperties = {
    padding: '16px 24px 20px', display: 'flex', gap: '12px', background: '#0a0a0a', flexShrink: 0
};
