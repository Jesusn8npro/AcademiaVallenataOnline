                        ...
                        {mostrarMenu && (
                            <div className="dropdown-usuario-menu">
                                ...
                                <div className="dropdown-usuario-links">
                                    <Link href="/mi-perfil" className="dropdown-usuario-link" onClick={cerrarMenuUsuario}>
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                    ...
                                    {esAdmin ? (
                                        <>
                                            <Link href="/administrador/panel-contenido" className="dropdown-usuario-link">
                                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                            ...
                                            <Link href="/administrador/notificaciones" className="dropdown-usuario-link">
                                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                        ...
                                        <>
                                            <Link href="/mis-cursos" className="dropdown-usuario-link" onClick={cerrarMenuUsuario}>
                                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                            ...
                                            <Link href="/membresias" className="dropdown-usuario-link" onClick={cerrarMenuUsuario}>
                                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                    ...
                                    <Link href="/configuracion" className="dropdown-usuario-link" onClick={cerrarMenuUsuario}>
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
