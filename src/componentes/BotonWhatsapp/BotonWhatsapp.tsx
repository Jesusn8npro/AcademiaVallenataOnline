...
const BotonWhatsapp = () => {
    ...
    const numeroWhatsapp = '573212587616';

    // Mensaje predeterminado súper vendedor
    const mensajePredeterminado = encodeURIComponent(
        '¡Hola! 👋 Vi sus cursos en la Academia y estoy muy interesado/a. ¿Podrían ayudarme con información? 🎓✨'
    );
        ...
        <>
            ...
            <div className="mensaje-promocional">
                <div className="mensaje-contenido">
                    ...
                    <span className="mensaje-texto">¡Hola! ¿Necesitas ayuda con tu inscripción?</span>
                </div>
            </div>
        </>
    );
