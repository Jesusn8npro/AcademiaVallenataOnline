Commit: fix: add missing react-helmet-async dependency 
##########################################
### Download Github Archive Started...
### Thu, 18 Dec 2025 05:22:54 GMT
##########################################
...
#5 transferring context: 95.76kB 0.1s done
#5 DONE 0.1s
...
#11 [stage-0  6/15] RUN nix-env -if .nixpacks/nixpkgs-ffeebf0acf3ae8b29f8c7049cd911b9636efd7e7.nix && nix-collect-garbage -d
#11 CACHED
...
#15 0.546 (node:1) ExperimentalWarning: CommonJS module /nix/store/cgkpjpl1hspg30dlmv4hhvlhbvik1bn1-nodejs-23.2.0/lib/node_modules/npm/node_modules/debug/src/node.js is loading ES Module /nix/store/cgkpjpl1hspg30dlmv4hhvlhbvik1bn1-nodejs-23.2.0/lib/node_modules/npm/node_modules/supports-color/index.js using require().
#15 0.546 Support for loading ES Module in require() is an experimental feature and might change at any time
#15 0.546 (Use `node --trace-warnings ...` to show where the warning was created)
#15 0.955 npm error code ERESOLVE
#15 0.955 npm error ERESOLVE could not resolve
#15 0.956 npm error
#15 0.956 npm error While resolving: react-helmet-async@2.0.5
#15 0.956 npm error Found: react@19.2.1
#15 0.956 npm error node_modules/react
#15 0.956 npm error   react@"^19.2.0" from the root project
#15 0.956 npm error   peer react@"^16.5.1 || ^17.0.0 || ^18.0.0 || ^19.0.0" from lucide-react@0.561.0
#15 0.956 npm error   node_modules/lucide-react
#15 0.956 npm error     lucide-react@"^0.561.0" from the root project
#15 0.956 npm error   6 more (react-dom, react-dropzone, react-i18next, react-router, ...)
#15 0.956 npm error
#15 0.956 npm error Could not resolve dependency:
#15 0.956 npm error peer react@"^16.6.0 || ^17.0.0 || ^18.0.0" from react-helmet-async@2.0.5
#15 0.956 npm error node_modules/react-helmet-async
#15 0.956 npm error   react-helmet-async@"^2.0.5" from the root project
#15 0.956 npm error
#15 0.956 npm error Conflicting peer dependency: react@18.3.1
#15 0.956 npm error node_modules/react
#15 0.956 npm error   peer react@"^16.6.0 || ^17.0.0 || ^18.0.0" from react-helmet-async@2.0.5
#15 0.956 npm error   node_modules/react-helmet-async
#15 0.956 npm error     react-helmet-async@"^2.0.5" from the root project
#15 0.956 npm error
#15 0.956 npm error Fix the upstream dependency conflict, or retry
#15 0.956 npm error this command with --force or --legacy-peer-deps
#15 0.956 npm error to accept an incorrect (and potentially broken) dependency resolution.
#15 0.956 npm error
#15 0.956 npm error
#15 0.956 npm error For a full report see:
#15 0.956 npm error /root/.npm/_logs/2025-12-18T05_23_00_234Z-eresolve-report.txt
#15 0.957 npm error A complete log of this run can be found in: /root/.npm/_logs/2025-12-18T05_23_00_234Z-debug-0.log
...
0.956 npm error     react-helmet-async@"^2.0.5" from the root project
0.956 npm error
0.956 npm error Fix the upstream dependency conflict, or retry
0.956 npm error this command with --force or --legacy-peer-deps
0.956 npm error to accept an incorrect (and potentially broken) dependency resolution.
0.956 npm error
0.956 npm error
0.956 npm error For a full report see:
0.956 npm error /root/.npm/_logs/2025-12-18T05_23_00_234Z-eresolve-report.txt
0.957 npm error A complete log of this run can be found in: /root/.npm/_logs/2025-12-18T05_23_00_234Z-debug-0.log
------
