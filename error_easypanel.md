Commit: fix: force node 23 for easypanel deployment 
##########################################
### Download Github Archive Started...
### Wed, 17 Dec 2025 20:29:40 GMT
##########################################
...
#5 transferring context: 93.30kB 0.1s done
#5 DONE 0.1s
...
#12 [stage-0  9/15] RUN  caddy fmt --overwrite /assets/Caddyfile
#12 CACHED

#13 [stage-0  5/15] COPY .nixpacks/nixpkgs-ffeebf0acf3ae8b29f8c7049cd911b9636efd7e7.nix .nixpacks/nixpkgs-ffeebf0acf3ae8b29f8c7049cd911b9636efd7e7.nix
#13 CACHED
...
#15 1.512 npm error code EBADENGINE
#15 1.512 npm error engine Unsupported engine
#15 1.512 npm error engine Not compatible with your version of node/npm: mi-app@0.0.0
#15 1.512 npm error notsup Not compatible with your version of node/npm: mi-app@0.0.0
#15 1.512 npm error notsup Required: {"node":">=22.0.0"}
#15 1.512 npm error notsup Actual:   {"npm":"10.8.2","node":"v18.20.5"}
#15 1.514 npm error A complete log of this run can be found in: /root/.npm/_logs/2025-12-17T20_29_46_040Z-debug-0.log
...
1.512 npm error code EBADENGINE
1.512 npm error engine Unsupported engine
1.512 npm error engine Not compatible with your version of node/npm: mi-app@0.0.0
1.512 npm error notsup Not compatible with your version of node/npm: mi-app@0.0.0
1.512 npm error notsup Required: {"node":">=22.0.0"}
1.512 npm error notsup Actual:   {"npm":"10.8.2","node":"v18.20.5"}
1.514 npm error A complete log of this run can be found in: /root/.npm/_logs/2025-12-17T20_29_46_040Z-debug-0.log
------
